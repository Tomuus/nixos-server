...

{
  ...
  programs.bash.interactiveShellInit = ''
    o4xp() {
      ...
      'Xvfb :1 -screen 0 1920x1080x24 & sleep 1 && DISPLAY=:1 x11vnc -display :1 -forever -shared -localhost -passwd ortho4xp -xrandr & sleep 1 && cd /var/lib/ortho4xp-bundled && DISPLAY=:1 steam-run ./Ortho4XP'
